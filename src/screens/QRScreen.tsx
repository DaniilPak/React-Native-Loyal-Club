                    ...
                    navigation.setOptions({
                        headerRight: () => (
                            <View style={{ flexDirection: 'row', marginHorizontal: 5 }}>
                                <PressableIcon onPress={() => { navigation.navigate('History') }} icon='book-outline' />
                                <View style={{ width: 5 }}></View>
                                <PressableIcon2 onPress={() => { navigation.navigate('Scan QR') }} icon='qrcode-scan' />
                            </View>
                        ),
                    });
                }
            ...
            {qr &&
                <View>
                    <View style={styles.labelContainer}>
                        ...
                        <Text style={styles.tip}>
                            Show Your Personal QR to the Worker
                        </Text>
                    </View>
                    <ShrinkableContainer>
